...
namespace SettingsUI
{
    ...
    public class RWFSettingsUI : BaseUnityPlugin
    {
        ...
        internal static void UnreadySelf()
        {
        ...
        internal static void InjectUIElements()
        {
            ...
            if (!buttonGroupGo.Find("Mod Settings"))
            {
                ...
                settingsButtonGo.GetComponent<Button>().onClick.AddListener(UnreadySelf);
                ...
                backButton.onClick.AddListener(UnreadyAll);
                backButton.onClick.AddListener(ResyncLobby);
                backButton.onClick.AddListener(RequestJoinedRoom);
