...
#### Examples
An example of how to call this function can be seen in [Will's Wacky Game Modes](https://github.com/willuwontu/WillsWackyGamemodes/blob/main/WillsWackyGamemodes/WillsWackyGameModes.cs#L78).
```CSHARP
...
#### Example
Examples of how to use the class can be seen in the [CompatibilityHandlers](SettingsUI/CompatibilityHandlers/) folder. In this case, the Pick N' Cards compatibility handler looks like this:
```CSHARP
